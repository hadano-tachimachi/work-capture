      ...
      <button
        ...
        className={cn(
          ...
          isRecording
            ...
            : "size-[var(--capture-mic-size)] bg-gradient-to-br from-[var(--gradient-primary-from)] to-[var(--gradient-primary-to)] text-primary-foreground shadow-lg shadow-primary/35 ring-4 ring-primary/15",
          className
        )}
      >
